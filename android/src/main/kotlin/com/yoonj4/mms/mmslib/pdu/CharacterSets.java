...
package com.yoonj4.mms.mmslib.pdu;
...
public class CharacterSets {
     ...
     * @throws UnsupportedEncodingException thrown if no name for mibEnumValue can be found.
     */
     ...
     * @throws UnsupportedEncodingException thrown if no MIBEnum number for mimeName can be found.
     */
